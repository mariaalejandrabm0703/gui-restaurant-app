...
import {MyOrder as MyOrderC} from '../index';
...
describe('Pruebas de container MyOrder', () => {
  let store;
      ...
      <Provider store={store}>
        <BrowserRouter>
          <MyOrderC
            ...
            searchOrderAsync={searchOrderAsync}
            setProductsAsync={setProductsAsync}
            listProducts={listProductsC}
          />
        </BrowserRouter>
        ,
      </Provider>
  ...
  it('Compara snapshot del MyOrderC renderizado', () => {
    expect(wrapper).toMatchSnapshot();
  });
  
  it('renderiza el componente MyOrderC y verifica que exista componente FindOrder', () => {
